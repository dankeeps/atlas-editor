"""Regras de efeito sonoro do Ultradinâmico Criativo: as mesmas do Ultradinâmico (mapa de referência). Como o modelo tem menos elementos na tela, sai menos som.
